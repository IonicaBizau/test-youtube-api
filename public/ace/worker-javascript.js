...
define('ace/mode/javascript/jshint', ['require', 'exports', 'module'], function (require, exports, module) {
	...
	require = function e(t, n, r) {
		...
		9: [function (req, module, exports) {
			["log", "info", "warn", "error", "time", "timeEnd", "trace", "dir", "assert"].forEach(function (x) {
				exports[x] = nop;
			});
			function nop() {}
		}, {}],
		...
		"n4bKNg": [function (req, module, exports) {
			...
			var JSHINT = function () {
				...
				function doOption() {
					...
					if (nt.type === "members") {
						...
						body.forEach(function (m) {
							...
							if (ch1 === ch2 && (ch1 === "\"" || ch1 === "'")) {
								m = m.substr(1, m.length - 2).replace("\\b", "\b").replace("\\t", "\t").replace("\\n", "\n").replace("\\v", "\v").replace("\\f", "\f").replace("\\r", "\r").replace("\\\\", "\\").replace("\\\"", "\"");
							}
				...
				relation("==", function (left, right) {
					...
					if (!eqnull && state.option.eqeqeq) warning("W116", this, "===", "==");else if (isPoorRelation(left)) warning("W041", this, "===", left.value);else if (isPoorRelation(right)) warning("W041", this, "===", right.value);
         ...
         XXX value is discarded: wouldn't it need a warning ?
				...
				stmt("return", function () {
					if (this.line === state.tokens.next.line) {
						if (state.tokens.next.id === "(regexp)") warning("W092");
				...
				var lookupBlockType = function lookupBlockType() {
					...
					if (_.contains(["[", "{"], state.tokens.next.value)) bracketStack += 1;
					if (_.contains(["]", "}"], state.tokens.next.value)) bracketStack -= 1;
					do {
						pn = peek(i);
						pn1 = peek(i + 1);
					...
					if (o) {
						...
						for (x = 0; x < optionKeys.length; x++) {
							if (/^-W\d{3}$/g.test(optionKeys[x])) {
								...
								if (optionKeys[x] === "indent") newOptionObj["(explicitIndent)"] = o[optionKeys[x]] === false ? false : true;
							}
						}
					}
		...
		5: [function (req, module, exports) {
			...
			Lexer.prototype = {
				...
				scanMixedSpacesAndTabs: function scanMixedSpacesAndTabs() {
					var at, match;
	...
	}, _defineProperty(_ref, "9", [function (req, module, exports) {}, {}]), _defineProperty(_ref, 10, [function (req, module, exports) {
	...
	}, { "__browserify_process": 11 }]), _defineProperty(_ref, 11, [function (req, module, exports) {
	...
	}, {}]), _defineProperty(_ref, "jshint", [function (req, module, exports) {
