...
;(function (window) {
	...
	window.define = function (id, deps, _factory) {
		...
		if (!deps.length) deps = ['require', 'exports', 'module'];
		...
		function i(n, s) {
			if (!t[n]) {
				if (!e[n]) {
					...
					var r = e[n][1][t];return i(r ? r : t);
				}, u, u.exports);
			}return t[n].exports;
		}var r = typeof require == "function" && require;for (var s = 0; s < n.length; s++) {
			i(n[s]);
		}return i;
			...
			ElementStack.prototype.furthestBlockForFormattingElement = function (element) {
				...
				for (var i = this.elements.length - 1; i >= 0; i--) {
					var node = this.elements[i];
					if (node.node === element) return furthestBlock;
				...
				switch (c) {
					...
					default:
						if (c >= 0xD800 && c <= 0xDFFF || c >= 0x10FFFF) {
							/// @todo. The spec says > 0x10FFFF, not >=. Section 8.2.4.69.
							return 0xFFFD;
				...
				function TreeBuilder() {
					...
					modes.inBody.endTagP = function (name) {
						if (!tree.openElements.inButtonScope('p')) {
							...
							if (tree.currentStackItem().localName != 'p') tree.parseError('unexpected-end-tag', { name: 'p' });
							tree.openElements.popUntilPopped(name);
						}
					};
			...
			exports.inspect = function (obj, showHidden, depth, colors) {
				...
				var stylize = function stylize(str, styleType) {
				...
				if (!colors) {
					stylize = function stylize(str, styleType) {
						return str;
					};
				}
			...
			function isArray(ar) {
				return Array.isArray(ar) || (typeof ar === "undefined" ? "undefined" : _typeof(ar)) === 'object' && Object.prototype.toString.call(ar) === '[object Array]';
			}

			function isRegExp(re) {
				(typeof re === "undefined" ? "undefined" : _typeof(re)) === 'object' && Object.prototype.toString.call(re) === '[object RegExp]';
			}
			...
			var Object_create = Object.create || function (prototype, properties) {
				...
				if (prototype === null) {
					...
					if ((typeof prototype === "undefined" ? "undefined" : _typeof(prototype)) !== 'object') {
						throw new TypeError('typeof prototype[' + (typeof prototype === "undefined" ? "undefined" : _typeof(prototype)) + '] != \'object\'');
					}
					var Type = function Type() {};
					Type.prototype = prototype;
					object = new Type();
			...
			(function () {
				...
				function Buffer(subject, encoding, offset) {
					...
					if (typeof offset === 'number') {
						...
						switch (type = typeof subject === "undefined" ? "undefined" : _typeof(subject)) {
							case 'number':
      ...
      list should be an Array.");
				...
				function utf8ToBytes(str) {
					...
					for (var i = 0; i < str.length; i++) {
						if (str.charCodeAt(i) <= 0x7F) byteArray.push(str.charCodeAt(i));else {
				...
				function readFloat(buffer, offset, isBigEndian, noAssert) {
					...
					return req('./buffer_ieee754').readIEEE754(buffer, offset, isBigEndian, 23, 4);
				}
				...
				function readDouble(buffer, offset, isBigEndian, noAssert) {
					...
					return req('./buffer_ieee754').readIEEE754(buffer, offset, isBigEndian, 52, 8);
				}
				...
				function writeFloat(buffer, value, offset, isBigEndian, noAssert) {
					...
					req('./buffer_ieee754').writeIEEE754(buffer, value, offset, isBigEndian, 23, 4);
				}
				...
				function writeDouble(buffer, value, offset, isBigEndian, noAssert) {
					...
					req('./buffer_ieee754').writeIEEE754(buffer, value, offset, isBigEndian, 52, 8);
				}
